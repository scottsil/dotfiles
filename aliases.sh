...
alias 193='rvm use ruby-head'
alias jruby='rvm use jruby-1.6.3'
alias macruby='rvm use macruby-0.10'
alias rbx='rvm use rbx-head'
alias ree='rvm use ree'
alias ruby-head='rvm use ruby-head'
alias searchd='/Users/scottsil/projects/airbnb/search/bin/start-search-dev.bash'
alias dyson='sh /Users/scottsil/projects/airbnb/dyson/dyson-local.arx'
alias o2='git submodule update --init --recursive'
alias pairbnb='cd /Users/scottsil/projects/airbnb/airbnb'
alias start_airbnb='/usr/local/nginx/sbin/nginx'
alias stop_airbnb='kill `cat /usr/local/nginx/logs/nginx.pid`'